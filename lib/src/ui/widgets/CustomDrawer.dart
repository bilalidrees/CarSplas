...
import 'package:hiltonSample/src/ui/widgets/MyDrawer.dart';
//import 'package:hiltonSample/src/bloc/AuthenticationBloc.dart';
...
class CustomDrawer extends StatefulWidget {
 ...
 final AuthenticationBloc authenticationBloc;
  ...
  const CustomDrawer({Key key, @required this.child, this.authenticationBloc})
      : super(key: key);
...
class CustomDrawerState extends State<CustomDrawer>
  ...
  static double maxSlide;
  var shortestSide;
  var isMobileScreen;
  static double minDragStartEdge = 60;
  static double maxDragStartEdge = maxSlide - 16;
  AnimationController _animationController;
  final GlobalKey<MyDrawerState> _myDrawerKey = new GlobalKey<MyDrawerState>();
  ...
  void open() {
    print("open drawer");
    _myDrawerKey.currentState.refreshDrawer();
  ...
  Widget build(BuildContext context) {
    ...
    isMobileScreen = shortestSide < 600;
    maxSlide = isMobileScreen ? 225 : 450;
    return WillPopScope(
      onWillPop: () async {
