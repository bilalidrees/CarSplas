...
class MySearchMapPlaceWidget extends StatefulWidget {
  MySearchMapPlaceWidget({
  ...
  @override
  _MySearchMapPlaceWidgetState createState() => _MySearchMapPlaceWidgetState();
}

class _MySearchMapPlaceWidgetState extends State<MySearchMapPlaceWidget>
  ...
  void initState() {
    ...
    _containerHeight = Tween<double>(begin: 55, end: 370).animate(
      CurvedAnimation(
    ...
    return Center(
      child: Row(
        children: <Widget>[
          ...
          Container(width: 15),
          GestureDetector(
            child: Icon(Icons.clear, color: this.widget.iconColor),
            onTap: () {
              _textEditingController.text = "";
            },
          ),
          SizedBox(width: AppConfig.of(context).appHeight(2)),
          GestureDetector(
